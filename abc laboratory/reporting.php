        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<a href='#' class='btn btn-sm btn-info addReportBtn' data-toggle='modal' data-target='#addReportModal' data-user-id='" . $row['user_id'] . "'><i class='fas fa-plus-circle'></i> Add</a>";

                    echo "<a href='#' class='btn btn-sm btn-warning editUserBtn' data-user-id='" . $row['user_id'] . "'><i class='fas fa-pencil-alt'></i> Edit</a>";
                    echo "<a href='#' class='btn btn-sm btn-success uploadUserBtn' data-user-id='" . $row['user_id'] . "'><i class='fas fa-upload'></i> Upload</a>";
